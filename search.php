<?php
session_start();
if(!isset($_SESSION['username']) || empty($_SESSION['username'])) { // If they're not logged in properly, throw user back to login page
...
<head>
	...
	<meta property="og:title" content="@_Helpers.Molloy_PageTitle(Model)" />	
...
<body id="" class="standardPage page" data-pagetype="StandardPage" data-components="" data-animated="fadeIn" data-bg-header="true" data-ext-responsive="false" data-header-resize="1" data-header-color="light" data-transparent-header="false" data-smooth-scrolling="1" data-responsive="1" >
    <!--[if lt IE 7]>
	...
	<div id="page" class="@page_class">		
		...
		<div class="container-wrap">			
			<div class="main-content container">				
				<?php include 'pageancestornavigation.php';?>
				<?php include 'bodycopy_resumes.php';?>
				<?php include 'pagecontactinformation.php';?>
			</div>				
		</div>					
